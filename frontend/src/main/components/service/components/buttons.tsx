...
export default function ButtonsBlock() {
    ...
    return (
      <>
        {isMachineError ? (
          ...
          <div className={buttonStyle.buttons_container}>
            {location.pathname.search("info") > 0 &&
            user &&
            user.group == "Manager" ? (
              <Link
                to={`edit_${name}/${path}`}
            ...
            {location.pathname.search("complaints") > 0 &&
            user &&
            (user.group == "Manager" ||
              user.group == "Service_Organization") ? (
              <Link
                to={`edit_${name}/${path}`}
                className={buttonStyle.button + " " + buttonStyles.medium}
                type='submit'
            ...
            {location.pathname.search("to") < 10 &&
            location.pathname.search("to") > 0 ? (
              <Link
                to={`edit_${name}/${path}`}
                className={buttonStyle.button + " " + buttonStyles.medium}
                type='submit'
  ...
  if (user) {
    ...
    if (
      location.pathname.endsWith("/create_machine") &&
      user.group == "Manager"
    ) {
    ...
    if (
      location.pathname.endsWith("/create_complaint") &&
      (user.group == "Manager" || user.group == "Service_Organization")
    ) {
